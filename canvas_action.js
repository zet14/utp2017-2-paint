...
class Rectangle extends Form {
        ...
        drawBottom(){
            bottom_ctx.strokeStyle = this.color;
            bottom_ctx.globalAlpha = this.visibility;
            bottom_ctx.strokeRect(this.pos1x,this.pos1y,this.pos2x - this.pos1x,this.pos2y - this.pos1y);
        }
...
class Square extends Form {
	    ...
	    var d = Math.max(Math.abs(a),Math.abs(b));
            ctx.strokeRect(this.pos1x, this.pos1y, d*Math.sign(a), d*Math.sign(b));
	    ...
	    var a = this.pos2x-this.pos1x;
            var b = this.pos2y-this.pos1y;
	    var d = Math.max(Math.abs(a),Math.abs(b));
            bottom_ctx.strokeRect(this.pos1x, this.pos1y, d*Math.sign(a), d*Math.sign(b));
        }
    }

class BaseLine extends Form{
...
class Triangle extends Form {
    ...
    drawTop() {
        ...
        ctx.moveTo( this.pos1x, this.pos1y );
        ctx.lineTo( this.pos2x, this.pos2y );
	ctx.lineTo( this.pos3x, this.pos3y );
	ctx.lineTo( this.pos1x, this.pos1y );
        ctx.stroke();
        ctx.closePath();
    }
    ...
    drawBottom() {
        ...
        bottom_ctx.moveTo( this.pos1x, this.pos1y );
        bottom_ctx.lineTo( this.pos2x, this.pos2y );
        bottom_ctx.lineTo( this.pos3x, this.pos3y );
...
class Fill {
    constructor( pos1x, pos1y ){//теперь принимаю 2 координаты
...
objNameSpace.Rectangle = Rectangle;
objNameSpace.Square = Square;
